...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	 ...
	 * [0] = LAYOUT(
	    ...
	    KC_LCTL, KC_Z, KC_X, KC_C, KC_V, KC_B, MO(3), MO(4), KC_N, KC_M, KC_COMM, KC_DOT, KC_PSLS, KC_RCTL,
	                        KC_LGUI, KC_DEL, LT(1,KC_SPC), LT(2,KC_SPC), KC_BSPC, KC_RALT
	),
	*/
	/* COLEMAK MOD DH */
	[0] = LAYOUT(
	...
	[1] = LAYOUT(
		...
		KC_TRNS, KC_NO, KC_NO,   KC_NO,   KC_NO,  KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
		                           KC_NO, KC_TRNS, KC_NO, KC_ENT, KC_NO, KC_TRNS
	),
	[2] = LAYOUT(
